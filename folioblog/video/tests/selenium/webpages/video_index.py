...
class VideoIndexWebPage(BaseIndexWebPage):
    ...
    def scroll_to_video(self, index):
        locator = (
            By.CSS_SELECTOR,
            f".video-item:nth-child({index}) .video-youtube-thumbnail",
        )
    ...
    def play_video(self, index):
        locator = (
            By.CSS_SELECTOR,
            f".video-item:nth-child({index}) .youtube-player-button",
        )
    ...
    def stop_video(self, index):
        locator = (
            By.CSS_SELECTOR,
            f".video-item:nth-child({index}) .video-youtube-player-wrapper",
        )
